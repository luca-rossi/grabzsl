...
--dataset AWA2 --seed {args.seed} --features_per_class 4600 --n_epochs 30 \
--n_critic_iters 1 --freeze_dec --lr 0.00001 \
--weight_critic 10 --weight_generator 10 --weight_precls 0.01 --weight_recons 0.001 \
--center_margin 50 --weight_margin 0.5 --weight_center 0.5'
if args.split:
